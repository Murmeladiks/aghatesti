modifier_player_perk_spell_radius = class({})

function modifier_player_perk_spell_radius:IsHidden() return false end
function modifier_player_perk_spell_radius:IsDebuff() return false end
function modifier_player_perk_spell_radius:IsPurgable() return false end
function modifier_player_perk_spell_radius:GetAttributes() return MODIFIER_ATTRIBUTE_PERMANENT + MODIFIER_ATTRIBUTE_IGNORE_INVULNERABLE end

function modifier_player_perk_spell_radius:GetTexture() return "perks/spell_radius" end

function modifier_player_perk_spell_radius:OnCreated(keys)
	self:OnRefresh(keys)
...
function modifier_player_perk_spell_radius:OnRefresh(keys)
...
function modifier_player_perk_spell_radius:DeclareFunctions()
	return {
...
function modifier_player_perk_spell_radius:GetModifierBonusStats_Intellect()
	return self.base_int + self.level_int * (self:GetParent():GetLevel() or 0)
end

function modifier_player_perk_spell_radius:GetModifierOverrideAbilitySpecial(keys)
...
function modifier_player_perk_spell_radius:GetModifierOverrideAbilitySpecialValue(keys)
