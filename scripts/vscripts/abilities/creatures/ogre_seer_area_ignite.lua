...
function ogre_seer_area_ignite:OnSpellStart()
	if IsServer() then
		...
		vTargetPositions[ 2 ] = self:GetCursorPosition() + RandomVector( Script_RandomFloat( 250, 300 ) )
		vTargetPositions[ 3 ] = self:GetCursorPosition() + RandomVector( Script_RandomFloat( 250, 300 ) )
