if not CDOTA_Modifier_Lua then
	CDOTA_Modifier_Lua = C_DOTA_Modifier_Lua
end

-- Independent Stacks
function CDOTA_Modifier_Lua:AddIndependentStack(stacks, duration, limit, remove_on_expire)
	...
	local timer_name =
		Timers:CreateTimer(
		duration or self:GetRemainingTime(),
		function(inner_timer_name)
