LinkLuaModifier("modifier_tusk_frozen_sigil_pf_aura", "heroes/tusk/tusk_pf", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_tusk_frozen_sigil_pf_effect", "heroes/tusk/tusk_pf", LUA_MODIFIER_MOTION_NONE)
