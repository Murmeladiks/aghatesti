...
LinkLuaModifier( "modifier_axe_counter_helix_lua", "heroes/axe/modifier_axe_counter_helix_lua", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_axe_counter_helix_special_fury", "heroes/axe/modifier_axe_counter_helix_lua", LUA_MODIFIER_MOTION_NONE )
...
function modifier_axe_counter_helix_aura:GetAuraRadius()
	if IsServer() then
		...
		if not special or special:IsNull() then return 0 end
