...
ogre_magi_bloodlust_lua_curve = ogre_magi_bloodlust_lua
LinkLuaModifier( "modifier_ogre_magi_bloodlust_lua", "heroes/ogre_magi/ogre_magi_bloodlust_lua/modifier_ogre_magi_bloodlust_lua", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_ogre_magi_bloodlust_lua_buff", "heroes/ogre_magi/ogre_magi_bloodlust_lua/modifier_ogre_magi_bloodlust_lua_buff", LUA_MODIFIER_MOTION_NONE )
