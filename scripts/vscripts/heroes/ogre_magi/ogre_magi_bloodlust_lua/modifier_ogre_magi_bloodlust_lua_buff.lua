...
--------------------------------------------------------------------------------
LinkLuaModifier( "modifier_ogre_magi_bloodlust_shield", "heroes/ogre_magi/ogre_magi_bloodlust_lua/modifier_ogre_magi_bloodlust_lua_buff", LUA_MODIFIER_MOTION_NONE )
