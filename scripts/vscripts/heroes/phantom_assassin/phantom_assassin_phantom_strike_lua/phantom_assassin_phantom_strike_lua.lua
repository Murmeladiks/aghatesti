LinkLuaModifier( "modifier_phantom_assassin_phantom_strike_lua", 	"heroes/phantom_assassin/phantom_assassin_phantom_strike_lua/modifier_phantom_assassin_phantom_strike_lua", LUA_MODIFIER_MOTION_NONE )
...
function phantom_assassin_phantom_strike_lua:GetAOERadius()
...
function phantom_assassin_phantom_strike_lua:OnSpellStart()
	...
	if caster:HasAbility("pathfinder_special_pa_blink_illusion") then
	...
	if caster:HasAbility("pathfinder_special_pa_blink_aoe") then
