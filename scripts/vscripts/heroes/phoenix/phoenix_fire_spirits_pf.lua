...
LinkLuaModifier("modifier_phoenix_fire_spirits_pf_count", "heroes/phoenix/phoenix_fire_spirits_pf", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_phoenix_fire_spirit_shell", "heroes/phoenix/phoenix_fire_spirits_pf", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_phoenix_fire_spirit_baby", "heroes/phoenix/phoenix_fire_spirits_pf", LUA_MODIFIER_MOTION_NONE)
...
LinkLuaModifier("modifier_phoenix_fire_spirits_pf_debuff", "heroes/phoenix/phoenix_fire_spirits_pf", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_phoenix_fire_spirits_pf_buff", "heroes/phoenix/phoenix_fire_spirits_pf", LUA_MODIFIER_MOTION_NONE)
...
function modifier_phoenix_fire_spirits_pf_debuff:OnCreated()
	local ability = self:GetCaster():FindAbilityByName("phoenix_fire_spirits_pf")
...
function modifier_phoenix_fire_spirits_pf_debuff:OnIntervalThink()
	...
	if caster:HasAbility("phoenix_pf_blinding_sun") and self:GetElapsedTime() % 1 > self.nStacksApplied then
		...
		parent:AddNewModifier(caster, innate, "modifier_phoenix_pf_blinding_sun", {duration = innate:GetSpecialValueFor("blind_duration")})
	end
end
