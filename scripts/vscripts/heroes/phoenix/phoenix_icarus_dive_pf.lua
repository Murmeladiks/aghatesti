...
--			  Icarus Dive
-------------------------------------------
LinkLuaModifier("modifier_phoenix_icarus_dive_dash_dummy_pf", "heroes/phoenix/phoenix_icarus_dive_pf", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_phoenix_icarus_dive_ignore_turn_ray_pf", "heroes/phoenix/phoenix_icarus_dive_pf", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_phoenix_icarus_dive_slow_debuff_pf", "heroes/phoenix/phoenix_icarus_dive_pf", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_phoenix_icarus_dive_speed", "heroes/phoenix/phoenix_icarus_dive_pf", LUA_MODIFIER_MOTION_NONE)
	...
	if IsServer() and self:GetCaster():HasAbility("pathfinder_icarus_dive_flyby") and self.flyby_cd == 1 then
		...
		for i=1,count do			
			Timers(0.3 * count, function()
				if spell and not spell:IsNull() and target and not target:IsNull() and target:IsAlive() then
