...
function modifier_dawnbreaker_starbreaker_lua:IsHidden() 	return true end
function modifier_dawnbreaker_starbreaker_lua:IsDebuff() 	return false end
function modifier_dawnbreaker_starbreaker_lua:IsPurgable() 	return false end
...
function modifier_dawnbreaker_starbreaker_lua:OnCreated( kv )
	...
	-- Start interval
	self:StartIntervalThink( interval - FrameTime())
...
function modifier_universal_sleep:IsHidden() 	return false end
function modifier_universal_sleep:IsDebuff() 	return true end
function modifier_universal_sleep:IsPurgable() 	return true end
