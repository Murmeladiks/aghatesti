...
LinkLuaModifier("modifier_dawnbreaker_luminosity_lua", "heroes/dawnbreaker/dawnbreaker_luminosity_lua/modifier_dawnbreaker_luminosity_lua", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier("modifier_dawnbreaker_luminosity_lua_charge", "heroes/dawnbreaker/dawnbreaker_luminosity_lua/dawnbreaker_luminosity_lua", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier("modifier_dawnbreaker_luminosity_lua_buff", "heroes/dawnbreaker/dawnbreaker_luminosity_lua/modifier_dawnbreaker_luminosity_lua_buff", LUA_MODIFIER_MOTION_NONE )
...
function modifier_dawnbreaker_luminosity_lua_charge:IsHidden() 		return true end
function modifier_dawnbreaker_luminosity_lua_charge:IsDebuff() 		return false end
function modifier_dawnbreaker_luminosity_lua_charge:IsPurgable() 	return false end
