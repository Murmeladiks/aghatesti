...
LinkLuaModifier( "modifier_dawnbreaker_luminosity_lua_stacking", "heroes/dawnbreaker/dawnbreaker_luminosity_lua/dawnbreaker_luminosity_lua", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_dawnbreaker_luminosity_lua_explosion", "heroes/dawnbreaker/dawnbreaker_luminosity_lua/dawnbreaker_luminosity_lua", LUA_MODIFIER_MOTION_NONE )

function modifier_dawnbreaker_luminosity_lua:IsHidden() 	return self:GetStackCount() < 1 end
function modifier_dawnbreaker_luminosity_lua:IsDebuff() 	return false end
