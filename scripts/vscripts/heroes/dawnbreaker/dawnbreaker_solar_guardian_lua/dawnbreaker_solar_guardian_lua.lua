...
LinkLuaModifier( "modifier_dawnbreaker_solar_guardian_lua", "heroes/dawnbreaker/dawnbreaker_solar_guardian_lua/modifier_dawnbreaker_solar_guardian_lua", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_dawnbreaker_solar_guardian_lua_leap", "heroes/dawnbreaker/dawnbreaker_solar_guardian_lua/modifier_dawnbreaker_solar_guardian_lua_leap", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_dawnbreaker_solar_guardian_lua_permanent_thinker", "heroes/dawnbreaker/dawnbreaker_solar_guardian_lua/dawnbreaker_solar_guardian_lua", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_dawnbreaker_solar_guardian_lua_capture_victim", "heroes/dawnbreaker/dawnbreaker_solar_guardian_lua/dawnbreaker_solar_guardian_lua", LUA_MODIFIER_MOTION_NONE )
...
LinkLuaModifier( "modifier_generic_3_charges", "heroes/generic/modifier_generic_3_charges", LUA_MODIFIER_MOTION_NONE )
...
function dawnbreaker_solar_guardian_lua:CastFilterResultLocation( vLoc )
	...
	if not GameRules.Aghanim:GetCurrentRoom():IsInRoomBounds( vLoc ) or not GridNav:CanFindPath(self:GetCaster():GetAbsOrigin(), vLoc) then
		return UF_FAIL_CUSTOM
	end
...
function dawnbreaker_solar_guardian_lua:OnSpellStart()
	...
	point = GameRules.Aghanim:GetCurrentRoom():ClampPointToRoomBounds( point )
...
function dawnbreaker_solar_guardian_lua:Pulse(point, value_multiplier, forced_radius)	
	...
	local radius = forced_radius and forced_radius or self:GetSpecialValueFor( "radius" )
	...
	for _,ally in pairs(allies) do
		...
		if ally ~= self:GetCaster() then
			ParticleManager:ReleaseParticleIndex(
				ParticleManager:CreateParticle("particles/units/heroes/hero_dawnbreaker/dawnbreaker_solar_guardian_healing_buff.vpcf", PATTACH_ABSORIGIN_FOLLOW, ally)
			)
		end
	...
	local effect_cast = ParticleManager:CreateParticle("particles/units/heroes/hero_dawnbreaker/dawnbreaker_solar_guardian_damage.vpcf", PATTACH_ABSORIGIN_FOLLOW, self:GetCaster())
	ParticleManager:SetParticleControl(effect_cast, 0, self:GetCaster():GetOrigin())
	ParticleManager:SetParticleControl(effect_cast, 1, point)
	ParticleManager:SetParticleControl(effect_cast, 2, Vector(radius, 0, 0))
	ParticleManager:ReleaseParticleIndex(effect_cast)

	effect_cast = ParticleManager:CreateParticle("particles/units/heroes/hero_dawnbreaker/dawnbreaker_solar_guardian_ring_flames.vpcf", PATTACH_ABSORIGIN_FOLLOW, self:GetCaster())
	ParticleManager:SetParticleControl(effect_cast, 1, point)
	ParticleManager:SetParticleControl(effect_cast, 2, Vector(radius, 0, 0))

	effect_cast2 = ParticleManager:CreateParticle("particles/units/heroes/hero_dawnbreaker/dawnbreaker_solar_guardian_outer_diamonds.vpcf", PATTACH_CUSTOMORIGIN, nil)
	...
	effect_cast3 = ParticleManager:CreateParticle( "particles/units/heroes/hero_dawnbreaker/dawnbreaker_ambient_solar_flare.vpcf", PATTACH_WORLDORIGIN, self:GetCaster() )		
	ParticleManager:SetParticleControl(effect_cast3, 0, point)
	ParticleManager:SetParticleControl(effect_cast3, 1, point)
	ParticleManager:SetParticleControl(effect_cast3, 2, Vector(radius, 0, 0))

	Timers:CreateTimer(0.51, function()
