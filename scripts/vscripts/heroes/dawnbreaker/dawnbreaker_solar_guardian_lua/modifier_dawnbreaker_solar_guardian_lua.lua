...
function modifier_dawnbreaker_solar_guardian_lua:IsHidden() 	return false end
function modifier_dawnbreaker_solar_guardian_lua:IsDebuff() 	return false end
function modifier_dawnbreaker_solar_guardian_lua:IsPurgable() 	return false end
...
function modifier_dawnbreaker_solar_guardian_lua:OnIntervalThink()
	...
	if self:GetCaster():FindAbilityByName("dawnbreaker_luminosity_lua_stacking") then
		if self:GetParent():FindModifierByName("modifier_dawnbreaker_luminosity_lua_stacking") then
