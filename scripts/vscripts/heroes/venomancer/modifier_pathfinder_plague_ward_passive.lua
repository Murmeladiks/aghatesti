...
function modifier_pathfinder_plague_ward_passive:IsHidden() 	return true end
function modifier_pathfinder_plague_ward_passive:IsDebuff() 	return false end
function modifier_pathfinder_plague_ward_passive:IsPurgable() 	return false end

function modifier_pathfinder_plague_ward_passive:OnCreated(table)	
	if not IsServer() then return end
	local global_attack_ability = self:GetAbility():GetCaster():FindAbilityByName("pathfinder_special_venomancer_ward_global_attack")
	if not global_attack_ability then return end

	self.dmg_penalty = global_attack_ability:GetSpecialValueFor("dmg_penalty")
