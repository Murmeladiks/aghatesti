...
function modifier_pathfinder_special_venomancer_bigass_ward_dummy:IsHidden() 		return true end
function modifier_pathfinder_special_venomancer_bigass_ward_dummy:IsDebuff() 		return false end
function modifier_pathfinder_special_venomancer_bigass_ward_dummy:IsPurgable() 		return false end
function modifier_pathfinder_special_venomancer_bigass_ward_dummy:DestroyOnExpire() return false end
