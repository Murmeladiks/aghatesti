-- Link the Lua modifiers first
LinkLuaModifier("modifier_generic_3_charges", "heroes/snapfire/snapfire_scatterblast_double_barrel", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_snapfire_scatterblast_double_barrel", "heroes/snapfire/snapfire_scatterblast_double_barrel", LUA_MODIFIER_MOTION_NONE)

-- Define the ability class
aghsfort_special_snapfire_scatterblast_double_barrel = class({})

-- Define the intrinsic modifier
function aghsfort_special_snapfire_scatterblast_double_barrel:GetIntrinsicModifierName()
    return "modifier_snapfire_scatterblast_double_barrel"
end

-- Define the modifier class
modifier_snapfire_scatterblast_double_barrel = class({})

-- Modifier functions
function modifier_snapfire_scatterblast_double_barrel:IsHidden()
    return true
end

function modifier_snapfire_scatterblast_double_barrel:IsPurgeException()
    return false
end

function modifier_snapfire_scatterblast_double_barrel:IsPurgable()
    return false
end

function modifier_snapfire_scatterblast_double_barrel:IsPermanent()
    return true
end

function modifier_snapfire_scatterblast_double_barrel:OnCreated(kv)
    if IsServer() then
...
-- Define the generic 3 charges modifier class
