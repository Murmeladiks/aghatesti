...
LinkLuaModifier( "modifier_snapfire_mortimer_kisses_lua", "heroes/snapfire/modifier_snapfire_mortimer_kisses_lua", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_snapfire_mortimer_kisses_lua_thinker", "heroes/snapfire/modifier_snapfire_mortimer_kisses_lua_thinker", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_snapfire_mortimer_kisses_lua_debuff", "heroes/snapfire/modifier_snapfire_mortimer_kisses_lua_debuff", LUA_MODIFIER_MOTION_NONE )
...
function snapfire_mortimer_kisses_lua:OnProjectileHit( target, location )
	...
	print("DEBUG: Blob hit at location", location)
	-- load data
