...
function pathfinder_juggernaut_wind_breathing:GetAOERadius()
	return self:GetSpecialValueFor( "max_travel_distance" ) + self:GetCaster():GetCastRangeBonus()
end
...
function pathfinder_juggernaut_wind_breathing:OnSpellStart()
	...
	local max_dist = self:GetSpecialValueFor( "max_travel_distance" ) + caster:GetCastRangeBonus()
