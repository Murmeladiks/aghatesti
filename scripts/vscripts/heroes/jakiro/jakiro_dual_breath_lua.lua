...
LinkLuaModifier( "modifier_jakiro_dual_breath_lua", "heroes/jakiro/modifier_jakiro_dual_breath_lua", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_jakiro_dual_breath_lua_fire", "heroes/jakiro/modifier_jakiro_dual_breath_lua_fire", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_jakiro_dual_breath_lua_ice", "heroes/jakiro/modifier_jakiro_dual_breath_lua_ice", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_pathfinder_jakiro_dual_breath_fart", "heroes/jakiro/jakiro_dual_breath_lua", LUA_MODIFIER_MOTION_NONE )
