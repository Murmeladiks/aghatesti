...
LinkLuaModifier( "modifier_jakiro_macropyre_lua", "heroes/jakiro/modifier_jakiro_macropyre_lua", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_jakiro_macropyre_lua_thinker", "heroes/jakiro/modifier_jakiro_macropyre_lua_thinker", LUA_MODIFIER_MOTION_NONE )

--------------------------------------------------------------------------------

function jakiro_macropyre_lua:Precache( context )
	...
	PrecacheResource("particle", "particles/econ/items/undying/fall20_undying_head/fall20_undying_soul_rip_heal_body.vpcf", context)
