...
function modifier_jakiro_macropyre_lua_thinker:IsHidden() 		return false end
function modifier_jakiro_macropyre_lua_thinker:IsDebuff() 		return false end
function modifier_jakiro_macropyre_lua_thinker:IsStunDebuff() 	return false end
function modifier_jakiro_macropyre_lua_thinker:IsPurgable() 	return false end
