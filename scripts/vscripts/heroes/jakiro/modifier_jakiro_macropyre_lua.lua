...
function modifier_jakiro_macropyre_lua:IsHidden() return false end
function modifier_jakiro_macropyre_lua:IsStunDebuff() return false end
function modifier_jakiro_macropyre_lua:IsPurgable() return false end
