...
function TempleGuardianThink()
	...
	local hWintersCurseBuff = thisEntity:FindModifierByName( "modifier_winter_wyvern_pf_winters_curse" )
	...
	local hCreatures = Entities:FindAllByClassnameWithin( "npc_dota_creature", thisEntity:GetAbsOrigin(), 3500 )
	local hGuardians = {}
