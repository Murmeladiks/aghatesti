...
function Spawn( entityKeyValues )
	...
	if thisEntity.hStiflingAbility and not thisEntity.hStiflingAbility:IsNull() then
		thisEntity.hStiflingAbility:SetLevel( 4 )
	end
	if thisEntity.hBlinkStrikeAbility and not thisEntity.hBlinkStrikeAbility:IsNull() then
...
function BanditCaptainThink()
	...
	if not thisEntity.hStiflingAbility or thisEntity.hStiflingAbility:IsNull() then
		thisEntity.hStiflingAbility = thisEntity:FindAbilityByName( "bandit_stifling_dagger" )
	...
	if not thisEntity.hBlinkStrikeAbility or thisEntity.hBlinkStrikeAbility:IsNull() then
		thisEntity.hBlinkStrikeAbility = thisEntity:FindAbilityByName( "bandit_stifling_dagger" )
	...
	local fDelayBeforeStifling = Script_RandomFloat( 2, 4 )
	...
	local fDelayBeforeBlinkStrike = Script_RandomFloat( 3, 5 )
