...
function Spawn( entityKeyValues )
	...
	thisEntity.flDisruptionDelayTime = GameRules:GetGameTime() + Script_RandomFloat( 7, 12 )	-- need to live for this long before we can think about casting disruption
