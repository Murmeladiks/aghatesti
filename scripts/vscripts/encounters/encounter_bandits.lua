...
function CMapEncounter_Bandits:constructor( hRoom, szEncounterName )
	...
	local flPortalIntervalInput = 50.0
	...
	for i = 1, nNumPortals do
		...
		self:AddPortalSpawner( CPortalSpawner( name, szLocatorName, 130 * hRoom:GetDepth(), flInitialPortalSpawnDelay, flInitialSummonTime, flPortalIntervalInput, flScaleInput,
			{
				{
					EntityName = "npc_dota_creature_bandit",
					Team = DOTA_TEAM_BADGUYS,
	...
	-- Wave 2A
	nNumPortals = 3
	flInitialPortalSpawnDelay = 20.0
	...
	for i = 1, nNumPortals do
		local name = string.format( "portal_%i", nNameCounter )
		nNameCounter = nNameCounter + 1
		self:AddPortalSpawner( CPortalSpawner( name, szLocatorName, 175 * hRoom:GetDepth(), flInitialPortalSpawnDelay, flInitialSummonTime, flPortalIntervalInput, flScaleInput,
			{
				{
	...
	-- Wave 3A
	nNumPortals = 2
	flInitialPortalSpawnDelay = 35.0
	flInitialSummonTime = 6.0
	flScaleInput = 1.0
