...
function modifier_rock_golem_split:OnDeath( params )
	...
	for i = 1,self.unit_count do
		local knockback_duration = Script_RandomFloat( self.knockback_duration_min, self.knockback_duration_max )
		local knockback_distance = Script_RandomFloat( self.knockback_distance_min, self.knockback_distance_max )
		local knockback_height = Script_RandomFloat( self.knockback_height_min, self.knockback_height_max )
