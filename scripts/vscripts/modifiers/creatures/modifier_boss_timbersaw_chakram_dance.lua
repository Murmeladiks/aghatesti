...
function modifier_boss_timbersaw_chakram_dance:ChooseRandomPointsOnEdges()
	...
	if nSide <= 2 then
		...
		retVal.vSpawnOrigin.y = Script_RandomFloat( vClampedMins.y, vClampedMaxs.y )
		retVal.vDestination.y = Script_RandomFloat( vClampedMins.y, vClampedMaxs.y )
	else
		if nSide == 3 then
		...
		retVal.vSpawnOrigin.x = Script_RandomFloat( vClampedMins.x, vClampedMaxs.x )
		retVal.vDestination.x = Script_RandomFloat( vClampedMins.x, vClampedMaxs.x )
	end
